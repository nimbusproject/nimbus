...
class TestEC2SubmitCommon(unittest.TestCase):
    ...
    def _make_user(self):
        ...
        self.s3user2 = self.can_user2.create_alias(self.s3id2, pynimbusauthz.alias_type_s3, self.friendly2, self.s3pw2)
        self.dnuser2 = self.can_user2.create_alias(self.subject2, pynimbusauthz.alias_type_x509, self.friendly2)
