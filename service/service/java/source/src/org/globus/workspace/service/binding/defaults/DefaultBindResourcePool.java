...
public class DefaultBindResourcePool implements BindResourcePool {
    ...
    private static final Log logger =
            LogFactory.getLog(DefaultBindResourcePool.class.getName());


    public void consume(VirtualMachine vm, String resourcePool)
            throws CreationException, ResourceRequestDeniedException {

        vm.setResourcePool(resourcePool);
    }
}
