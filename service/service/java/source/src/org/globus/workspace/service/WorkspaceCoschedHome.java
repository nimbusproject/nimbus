...
public interface WorkspaceCoschedHome {

    public CoschedResource newCosched(String creatorID)
    ...
    public void destroy(String id) throws ManageException, DoesNotExistException;

    /**
     * @param coschedid uuid resource key
