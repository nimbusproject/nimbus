...
public class Reboot_Group extends WSAction_Group {
     ...
     * @see WSAction_Group
     */
    public Reboot_Group(EndpointReferenceType epr,
     ...
     * @see WSAction_Group
     */
    public Reboot_Group(WorkspaceGroupPortType groupPortType,
                        Print debug) {
    ...
    /**
     * Reboot group of workspaces.
     * 
     * @throws ParameterProblem validation problem
     * @throws ExecutionProblem general problem running (connection errors etc)
     * @throws WorkspaceShutdownFault couldn't reboot
     * @throws OperationDisabledFault not allowed to reboot
     * @throws WorkspaceUnknownFault unknown
     */
    public void reboot() throws ParameterProblem,
                                ExecutionProblem,
        ...
        try {
            ...
            req.setShutdownType(ShutdownEnumeration.Reboot);
