...
public class Shutdown_Instance extends WSAction_Instance {
     ...
     */
    public Shutdown_Instance(EndpointReferenceType epr,
     ...
     * @see WSAction_Instance
     */
    public Shutdown_Instance(WorkspacePortType instancePortType,
                             Print debug) {
