...
public abstract class WSAction_Group extends WSAction {
    ...
    /**
     * New WorkspaceGroupPortType instance will be created from given parameters
     ...
     */
    public WSAction_Group(EndpointReferenceType epr,
    ...
    /**
     * Re-use pre-created WorkspaceGroupPortType instance.
     *
     * @param groupPortType to use for action, may not be null
     * @param debug    for debug messages; if null, a new instance of disabled
     *                 print impl will be created
     */
    public WSAction_Group(WorkspaceGroupPortType groupPortType,
                          Print debug) {
    ...
    public void validateAll() throws ParameterProblem {
        ...
        if (this.portType != null) {
            ...
            if (!(this.portType instanceof WorkspaceGroupPortType)) {
                throw new ParameterProblem(
                    "portType is not WorkspaceGroupPortType");
            }
        ...
        try {
            final WorkspaceGroupPortType port =
                    WSUtils.initGroupServicePortType(this.epr);
