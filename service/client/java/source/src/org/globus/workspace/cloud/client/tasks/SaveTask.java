...
public class SaveTask implements Callable {
    ...
    private final String saveTarget;
    ...
    public SaveTask(String eprFilePath,
        ...
        this.pr = print;
        this.saveTarget = newSaveTargetURL;
    ...
    int execute() {
        ...
        cmdList.add("--" + Opts.SHUTDOWN_SAVE_OPT_STRING);

        if (this.saveTarget != null) {
            cmdList.add("--" + Opts.SAVE_TARGET_OPT_STRING);
            cmdList.add(this.saveTarget);
        }
