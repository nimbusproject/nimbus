...
public class Reboot_Instance extends WSAction_Instance {
     ...
     */
    public Reboot_Instance(EndpointReferenceType epr,
     ...
     * @see WSAction_Instance
     */
    public Reboot_Instance(WorkspacePortType instancePortType,
                           Print debug) {
