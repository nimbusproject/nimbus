...
public class SubscribeCurrentState_Instance extends Subscribe_Common {

    // -------------------------------------------------------------------------
    // CONSTRUCTORS
    // -------------------------------------------------------------------------

    public SubscribeCurrentState_Instance(
    ...
    public SubscribeCurrentState_Instance(WorkspacePortType instancePortType,
                                          EndpointReferenceType consumerEndpoint) {
