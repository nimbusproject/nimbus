...
public class ShutdownSave_Instance extends WSAction_Instance {
     ...
     */
    public ShutdownSave_Instance(EndpointReferenceType epr,
     ...
     * @see WSAction_Instance
     */
    public ShutdownSave_Instance(WorkspacePortType instancePortType,
                                 Print debug) {
