...
public abstract class WSAction_Instance extends WSAction {
    ...
    /**
     * New WorkspacePortType instance will be created from given parameters
     ...
     */
    public WSAction_Instance(EndpointReferenceType epr,
    ...
    /**
     * Re-use pre-created WorkspacePortType instance.
     *
     * @param instancePortType to use for action, may not be null
     * @param debug    for debug messages; if null, a new instance of disabled
     *                 print impl will be created
     */
    public WSAction_Instance(WorkspacePortType instancePortType,
                             Print debug) {
    ...
    public void validateAll() throws ParameterProblem {
        ...
        if (this.portType != null) {
            ...
            if (!(this.portType instanceof WorkspacePortType)) {
                throw new ParameterProblem(
                    "portType is not WorkspacePortType");
            }
