...
public class Destroy_Instance extends WSAction_Instance {
     ...
     */
    public Destroy_Instance(EndpointReferenceType epr,
     ...
     * @see WSAction_Instance
     */
    public Destroy_Instance(WorkspacePortType instancePortType,
                            Print debug) {
