...
public class ResourceRequestDeniedException extends Exception {
    ...
    public ResourceRequestDeniedException(String message, Exception e) {
        super(message, e);
    }

    public ResourceRequestDeniedException(String message, Throwable e) {
        super(message, e);
    }

    public ResourceRequestDeniedException(Exception e) {
        super("", e);
    }
}
