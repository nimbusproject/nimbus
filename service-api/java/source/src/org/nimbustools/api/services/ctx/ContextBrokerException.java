...
public class ContextBrokerException extends Exception {
    ...
    public ContextBrokerException(String message, Exception e) {
        super(message, e);
    }

    public ContextBrokerException(String message, Throwable e) {
        super(message, e);
    }

    public ContextBrokerException(Exception e) {
        super("", e);
    }
}
