...
public class OperationDisabledException extends Exception {
    ...
    public OperationDisabledException(String message, Exception e) {
        super(message, e);
    }

    public OperationDisabledException(String message, Throwable e) {
        super(message, e);
    }

    public OperationDisabledException(Exception e) {
        super("", e);
    }
}
