...
public class RP_ResourceAllocation extends BasicRP {
    ...
    public RP_ResourceAllocation(InstanceResource resource) {
        super(Constants_GT4_0.RP_RESOURCE_ALLOCATION);
        if (resource == null) {
    ...
    public Object getValue() {
        return this.rsrc.getResourceAllocation();
    }
