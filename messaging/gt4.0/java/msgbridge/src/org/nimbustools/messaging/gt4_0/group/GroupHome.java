...
public class GroupHome implements ResourceHome, Initializable {
    ...
    private GroupTranslate translate;
    private Cache cache;
    ...
    public void initialize() throws Exception {
        ...
        // if subscriptions on group resources were supported, here is where
    ...
    public Resource find(ResourceKey rkey) throws ResourceException,
        ...
        final String groupid = this.convertKey(rkey);
