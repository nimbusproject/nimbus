...
m4_define([[[_NIMBUS_2_4_DEPRECATED',<!-- 2.4 is the current release candidate --><br><h2><font color="red"><b>Release candidate</b></font>: Stable version is <a href="http://www.nimbusproject.org/docs/">Nimbus 2.3</a>. The 2.4 RC documentation is <a href="/index.html">here</a></h2><br>)m4_dnl
m4_dnl
