...
public class AddOrReplacePublishHostname {

    // -------------------------------------------------------------------------
    // ADJUST
    // -------------------------------------------------------------------------

    public void addOrReplacePublishHostname(String newval,
    ...
    public static void main(String[] args) {
        ...
        if (args == null || args.length != 2) {
            System.err.println("Needs these arguments:\n" +
                    "1 - the new publishHostName value\n" +
                    "2 - the server-config.wsdd path");
            System.exit(1);
        }

        try {
            new AddOrReplacePublishHostname().
                    addOrReplacePublishHostname(args[0], args[1]);
        } catch (Exception e) {
            System.err.println("Problem with publishHostName: " + e.getMessage());
            System.exit(1);
        }
    }
}
