...
public class ReplaceGridmap {

    // -------------------------------------------------------------------------
    // REPLACE
    // -------------------------------------------------------------------------

    public void replaceGridmap(String newval,
    ...
    public static void main(String[] args) {
        ...
        if (args == null || args.length != 2) {
            System.err.println("Needs these arguments:\n" +
                    "1 - the new gridmap path value\n" +
                    "2 - the global_security_descriptor.xml path");
            System.exit(1);
        }

        try {
            new ReplaceGridmap().replaceGridmap(args[0], args[1]);
        } catch (Exception e) {
            System.err.println("Problem replacing gridmap value: " + e.getMessage());
            System.exit(1);
        }
    }
}
